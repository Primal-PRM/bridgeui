...
export class TestLibAddressArrayContract extends BaseContract {
    ...
    public static async deployAsync(
        ...
        const contractInstance = new TestLibAddressArrayContract(abi, txReceipt.contractAddress as string, provider, txDefaults);
        contractInstance.constructorArgs = [];
        return contractInstance;
    }
    constructor(abi: ContractAbi, address: string, supportedProvider: SupportedProvider, txDefaults?: Partial<TxData>) {
        super('TestLibAddressArray', abi, address, supportedProvider, txDefaults);
