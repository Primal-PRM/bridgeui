...
var OwnableContract = /** @class */ (function (_super) {
    ...
    function OwnableContract(abi, address, supportedProvider, txDefaults) {
        var _this = _super.call(this, 'Ownable', abi, address, supportedProvider, txDefaults) || this;
        _this.owner = {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        contractInstance = new OwnableContract(abi, txReceipt.contractAddress, provider, txDefaults);
