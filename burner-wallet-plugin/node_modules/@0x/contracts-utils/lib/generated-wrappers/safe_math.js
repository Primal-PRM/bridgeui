...
var SafeMathContract = /** @class */ (function (_super) {
    ...
    function SafeMathContract(abi, address, supportedProvider, txDefaults) {
        var _this = _super.call(this, 'SafeMath', abi, address, supportedProvider, txDefaults) || this;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        contractInstance = new SafeMathContract(abi, txReceipt.contractAddress, provider, txDefaults);
