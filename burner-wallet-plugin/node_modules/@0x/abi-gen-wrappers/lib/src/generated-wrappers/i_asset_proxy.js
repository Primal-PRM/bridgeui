...
var IAssetProxyContract = /** @class */ (function (_super) {
    ...
    function IAssetProxyContract(abi, address, supportedProvider, txDefaults) {
        var _this = _super.call(this, 'IAssetProxy', abi, address, supportedProvider, txDefaults) || this;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        contractInstance = new IAssetProxyContract(abi, txReceipt.contractAddress, provider, txDefaults);
