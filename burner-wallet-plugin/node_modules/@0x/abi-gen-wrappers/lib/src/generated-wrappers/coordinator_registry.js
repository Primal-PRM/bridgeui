...
var CoordinatorRegistryContract = /** @class */ (function (_super) {
    ...
    function CoordinatorRegistryContract(abi, address, supportedProvider, txDefaults) {
        var _this = _super.call(this, 'CoordinatorRegistry', abi, address, supportedProvider, txDefaults) || this;
        _this.setCoordinatorEndpoint = {
            ...
            getABIEncodedTransactionData: function (coordinatorEndpoint) {
                var self = this;
                var abiEncodedTransactionData = self._strictEncodeArguments('setCoordinatorEndpoint(string)', [coordinatorEndpoint
                ]);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        contractInstance = new CoordinatorRegistryContract(abi, txReceipt.contractAddress, provider, txDefaults);
